    ...
    return (
        <div class="flex flex-col items-center justify-center px-6 pt-8 mx-auto md:h-screen pt:mt-0 dark:bg-gray-900">
            <a href="/" class="flex items-center justify-center mb-8 text-2xl font-semibold lg:mb-10 dark:text-white">
                <img src={logo} class="mr-4 h-11" alt="FlowBite Logo" />
                <span>Flowbite</span>
            </a>
            <div class="w-full max-w-xl p-6 space-y-8 sm:p-8 bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <form class="mt-8 space-y-6" action="#">
                    ...
                    <div>
                        <TextField name="password" label="Your password" type="password" required />
                    </div>
                    <div class="flex items-start">
                        ...
                        <a href="#" class="text- ml-auto text-sm text-primary-700 hover:underline dark:text-primary-500">Lost Password?</a>
                    </div>
